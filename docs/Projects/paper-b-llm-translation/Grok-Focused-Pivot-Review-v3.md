...
> **Hand-carry file for grok.com chat window.** Paste this whole file
> into a fresh chat (no system prompt needed), then save Grok's reply to
> `External Reviews/v3-grok-review-5_3-only.md`.

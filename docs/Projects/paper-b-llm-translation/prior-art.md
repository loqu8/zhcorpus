...
## Our Claim
A single LLM (MiniMax M2.5) can translate 428K Chinese headwords into 12 languages for ~$20/month, with prompt engineering solving CJK leaks, kanji echo, and Hangul purity.

## Closest Related Work

### LLM-Powered Lexicography
- **Pre-Qin Philosophy Lexicon via Qwen3-14B** (Nature, 2025): Uses LLM to generate bilingual (Chinese-English) dictionary entries for classical Chinese philosophical terms. Small-scale (~1K terms), single language pair. Shows LLMs can do lexicography but at tiny scale.
...
- **Cost**: $20/month for complete multilingual dictionary is a strong claim. No comparable cost analysis published.

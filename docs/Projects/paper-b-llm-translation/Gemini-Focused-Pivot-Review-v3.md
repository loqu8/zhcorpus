...
> **Hand-carry file for gemini.google.com chat window.** Paste this
> whole file into a fresh chat (no system prompt needed), then save
> Gemini's reply to `External Reviews/v3-gemini-review-5_3-only.md`.

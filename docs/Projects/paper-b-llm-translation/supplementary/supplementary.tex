...
\noindent The Hokkien form \textit{tāu-hū} (Table~\ref{tab:dialect-samples}) is the etymological source for Indonesian \textit{tahu}, Tagalog \textit{tokwa} (via Hokkien \textit{tāu-koaⁿ} ``dried tofu''), and Thai \thi{เต้าหู้}---all visible in the multilingual definitions above.
